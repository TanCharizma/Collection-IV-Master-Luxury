...
(() => {
 ...
 root.innerHTML=`<div class="cal-topline"><span class="cal-label">${tr('An invitation to collaborate','งานร่วมกันครั้งถัดไป')}</span><span class="cal-demo">${tr('Interactive demo','ตัวอย่างทดลองใช้')}</span></div>
 <div class="cal-shell">
 <aside class="cal-panel cal-details"><img class="cal-avatar" src="image/about/01.webp" alt=""><div class="cal-owner"></div><h3>${tr('Booking request','ส่งคำขอจองคิว')}</h3><p class="cal-muted">${tr('Considered collaborations, beautifully realised. Choose a date and time to begin planning your next project.','เรื่องราวใหม่เริ่มต้นที่นี่ เลือกวันและเวลาสำหรับงานถ่ายภาพหรือโปรเจกต์สร้างสรรค์ครั้งถัดไป')}</p>
